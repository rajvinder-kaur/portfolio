              ...
              <div className="mobile_menu_container">
                ...
                <h3>Connect With Me</h3>
                  <div className="social_icons">
                    <a href="https://github.com/sujal-garg"><i className='fab fa-github'></i></a> 
                    <a href="https://twitter.com/im_SujalGarg"><i className='fab fa-twitter'></i></a>
                    <a href="https://www.linkedin.com/in/sujalgarg17/"><i className="fab fa-linkedin"></i></a>
                  </div>
                </div>
              </div>
            </nav>
